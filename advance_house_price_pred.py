...
plt.savefig('qq_saleprice_before_log.png', bbox_inches='tight', dpi=150)
plt.show()
df['SalePrice'] = np.log1p(df['SalePrice'])
stats.probplot(df['SalePrice'],dist='norm',plot=plt)
plt.title('Q-Q plot after LOG')
plt.savefig('qq_saleprice_after_log.png', bbox_inches='tight', dpi=150)
plt.show()
stats.probplot(df['GrLivArea'],dist='norm',plot=plt)
plt.savefig('qq_grlivarea_before_log.png', bbox_inches='tight', dpi=150)
plt.show()
df['GrLivArea'] = np.log1p(df['GrLivArea'])
stats.probplot(df['GrLivArea'],dist='norm',plot=plt)
plt.savefig('qq_grlivarea_after_log.png', bbox_inches='tight', dpi=150)
plt.show()
